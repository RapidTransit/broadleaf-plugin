...
class AdminPresentationClassWrapper(annotation: PsiAnnotation) : AnnotationWrapper(annotation) {
    ...
    companion object {
        ...
        val METHODS = mapOf<String, OverrideType>(Pair("ceilingDisplayEntity", OverrideType.STRING), Pair("excludeFromPolymorphism", OverrideType.BOOLEAN), Pair("friendlyName", OverrideType.STRING), Pair("groupOverrides)", OverrideType.ANNOTATION_ARRAY), Pair("populateToOneFields", OverrideType.ENUM), Pair("tabOverrides)", OverrideType.ANNOTATION_ARRAY), Pair("tabs)", OverrideType.ANNOTATION_ARRAY))
