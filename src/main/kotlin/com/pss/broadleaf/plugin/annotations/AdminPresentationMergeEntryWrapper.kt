...
class AdminPresentationMergeEntryWrapper(annotation: PsiAnnotation) : AnnotationWrapper(annotation) {
    ...
    companion object {
        ...
        val METHODS = mapOf<String, OverrideType>(Pair("booleanArrayOverrideValue", OverrideType.BOOLEAN_ARRAY), Pair("booleanOverrideValue", OverrideType.BOOLEAN), Pair("doubleArrayOverrideValue", OverrideType.DOUBLE_ARRAY), Pair("doubleOverrideValue", OverrideType.DOUBLE), Pair("floatArrayOverrideValue", OverrideType.FLOAT_ARRAY), Pair("floatOverrideValue", OverrideType.FLOAT), Pair("intArrayOverrideValue", OverrideType.INT_ARRAY), Pair("intOverrideValue", OverrideType.INT), Pair("keys)", OverrideType.ANNOTATION_ARRAY), Pair("longArrayOverrideValue", OverrideType.LONG_ARRAY), Pair("longOverrideValue", OverrideType.LONG), Pair("operationTypes)", OverrideType.ANNOTATION), Pair("optionFilterParams)", OverrideType.ANNOTATION_ARRAY), Pair("overrideValue", OverrideType.STRING), Pair("propertyType", OverrideType.STRING), Pair("showIfFieldEquals)", OverrideType.ANNOTATION_ARRAY), Pair("stringArrayOverrideValue", OverrideType.STRING_ARRAY), Pair("validationConfigurations)", OverrideType.ANNOTATION_ARRAY))
