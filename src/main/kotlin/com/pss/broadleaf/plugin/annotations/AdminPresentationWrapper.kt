...
class AdminPresentationWrapper(annotation: PsiAnnotation) : AnnotationWrapper(annotation) {
    ...
    companion object {
        ...
        val METHODS = mapOf<String, OverrideType>(Pair("addFriendlyName", OverrideType.STRING), Pair("allowNoValueEnumOption", OverrideType.BOOLEAN), Pair("associatedFieldName", OverrideType.STRING), Pair("broadleafEnumeration", OverrideType.STRING), Pair("canLinkToExternalEntity", OverrideType.BOOLEAN), Pair("columnWidth", OverrideType.STRING), Pair("currencyCodeField", OverrideType.STRING), Pair("defaultValue", OverrideType.STRING), Pair("displayType", OverrideType.ENUM), Pair("excluded", OverrideType.BOOLEAN), Pair("fieldComponentRenderer", OverrideType.ENUM), Pair("fieldType", OverrideType.ENUM), Pair("friendlyName", OverrideType.STRING), Pair("gridOrder", OverrideType.INT), Pair("group", OverrideType.STRING), Pair("groupCollapsed", OverrideType.BOOLEAN), Pair("groupOrder", OverrideType.INT), Pair("helpText", OverrideType.STRING), Pair("hideEnumerationIfEmpty", OverrideType.BOOLEAN), Pair("hint", OverrideType.STRING), Pair("largeEntry", OverrideType.BOOLEAN), Pair("order", OverrideType.INT), Pair("prominent", OverrideType.BOOLEAN), Pair("readOnly", OverrideType.BOOLEAN), Pair("requiredOverride", OverrideType.ENUM), Pair("ruleIdentifier", OverrideType.STRING), Pair("securityLevel", OverrideType.STRING), Pair("showIfFieldEquals)", OverrideType.ANNOTATION_ARRAY), Pair("showIfProperty", OverrideType.STRING), Pair("tab", OverrideType.STRING), Pair("tabOrder", OverrideType.INT), Pair("tooltip", OverrideType.STRING), Pair("translatable", OverrideType.BOOLEAN), Pair("validationConfigurations)", OverrideType.ANNOTATION_ARRAY), Pair("visibility", OverrideType.ENUM))
